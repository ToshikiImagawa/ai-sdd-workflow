...
マイグレーション状況に応じて、`output-templates` スキルを使用してマイグレーション結果を出力してください。
...
- [x] **ディレクトリ存在確認**: 移行前後のディレクトリ構造を確認
- [x] **Git 操作の成功確認**: `git mv` または設定ファイル生成の成功を確認
