...
```bash
bash "${CLAUDE_PLUGIN_ROOT}/skills/check-spec-cli-fallback/scripts/find-design-docs.sh" [feature-name]
```
...
```
auth/user-login     # Check user-login feature under auth domain
auth                # Check entire auth domain
```
