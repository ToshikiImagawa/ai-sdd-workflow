...
| `/task-cleanup`        | `/task-cleanup` | Cleanup command                 |
...
Depending on migration status, use the `templates/${SDD_LANG:-en}/migrate_output.md` template for output formatting.
...
```
This project is not under Git management.
